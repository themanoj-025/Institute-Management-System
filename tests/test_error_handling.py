...
class TestSafeImport:
    ...
    def test_import_valid_module(self, mock_ctk_app):
    ...
    def test_import_nonexistent_module(self, mock_ctk_app):
    ...
    def test_import_nonexistent_class(self, mock_ctk_app):
    ...
    def test_import_with_invalid_module_path(self, mock_ctk_app):
...
class TestGetModuleClass:
    ...
    def test_shared_route(self, mock_ctk_app):
    ...
    def test_admin_route(self, mock_ctk_app):
    ...
    def test_student_route_with_admin_role(self, mock_ctk_app):
    ...
    def test_student_route(self, mock_ctk_app):
    ...
    def test_admin_only_routes(self, mock_ctk_app):
...
class TestNavigate:
    ...
    def test_navigate_logout(self, mock_ctk_app):
    ...
    def test_navigate_same_route(self, mock_ctk_app):
    ...
    def test_navigate_unknown_route_restores_prev_route(self, mock_ctk_app):
    ...
    def test_navigate_sets_prev_route(self, mock_ctk_app):
    ...
    def test_navigate_module_import_failure(self, mock_ctk_app):
    ...
    def test_navigate_clears_content_area(self, mock_ctk_app):
    ...
    def test_navigate_success_path(self, mock_ctk_app):
...
class TestErrorDialog:
    ...
    def test_creates_dialog_with_correct_title(self, mock_ctk_app):
    ...
    def test_dialog_with_traceback_calls_add_details(self, mock_ctk_app):
    ...
    def test_dialog_without_traceback_skips_details(self, mock_ctk_app):
...
class TestAddErrorDetails:
    ...
    def test_creates_toggle_button(self, mock_ctk_app):
    ...
    def test_toggle_shows_and_hides(self, mock_ctk_app):
...
class TestGlobalExceptionHandler:
    ...
    def test_sets_sys_excepthook(self, mock_ctk_app):
        """sys.excepthook should be replaced."""
        mock_ctk_app._install_global_exception_handler()
        assert sys.excepthook is not sys.__excepthook__

    def test_excepthook_calls_after(self, mock_ctk_app):
    ...
    def test_excepthook_does_not_crash(self, mock_ctk_app):
    ...
    def test_report_callback_exception_set(self, mock_ctk_app):
...
class TestResetAppState:
    ...
    def test_resets_user_and_route(self, mock_ctk_app):
    ...
    def test_stops_session_tracker(self, mock_ctk_app):
    ...
    def test_handles_missing_session_tracker(self, mock_ctk_app):
    ...
    def test_stop_failure_does_not_crash(self, mock_ctk_app):
...
class TestRestartFromError:
    ...
    def test_restart_calls_reset_and_landing(self, mock_ctk_app):
...
class TestExitFromError:
    ...
    def test_exit_destroys_dialog_and_quits(self, mock_ctk_app):
...
class TestNavigateErrorDialog:
    ...
    def test_safe_import_error_shows_dialog_on_failure(self, mock_ctk_app):
    ...
    def test_navigate_calls_show_error_dialog_on_instantiation_failure(self, mock_ctk_app):
