...
class Attendance(Base):
    ...
    status = Column(Enum(AttendanceStatus), nullable=False)  # type: ignore
...
class Leave(Base):
    ...
    status = Column(Enum(LeaveStatus), default=LeaveStatus.pending)  # type: ignore
...
class Fee(Base):
    ...
    status = Column(Enum(FeeStatus), default=FeeStatus.unpaid)  # type: ignore
