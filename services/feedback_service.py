...
class FeedbackService:
    ...
    def submit_feedback(self, user_id: int, category: str, message: str) -> dict:
    ...
    def reply_to_feedback(self, feedback_id: int, replier_id: int, reply_text: str) -> dict | None:
    ...
    def _format_feedback(self, feedback: Feedback) -> dict:
        return {
            "id": feedback.id,
